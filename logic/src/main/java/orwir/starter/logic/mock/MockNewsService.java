...
public class MockNewsService implements NewsService {
    ...
    private static final List<Article> anonymousArticles = Arrays.asList(
            ...
            new Article(3L, "", "", "", date("26.07.2017")),
            new Article(4L, "", "", "", date("24.07.2017")),
            new Article(5L, "", "", "", date("22.07.2017")),
            new Article(6L, "", "", "", date("20.07.2017")),
            new Article(7L, "", "", "", date("18.07.2017")),
            new Article(8L, "", "", "", date("16.07.2017")),
            new Article(9L, "", "", "", date("14.07.2017")),
            new Article(10L, "", "", "", date("12.07.2017")),
            new Article(11L, "", "", "", date("10.07.2017"))
    );
